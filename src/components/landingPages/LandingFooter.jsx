        ...
        <div className="pt-4 mt-7 border-t border-primary w-full">
          <div className="flex justify-center gap-5 w-full">
            <div className="flex gap-5 items-center mt-5">
              ...
              >
                <BsFacebook className="text-xl text-white/90 hover:text-primary/90 transition-all duration-300" />
              </Link>
              <Link
                ...
                className="group border-white border p-3 rounded-full"
              >
                <BsTwitter className="text-xl text-white/90 hover:text-primary/90 transition-all duration-300" />
              </Link>
              <Link
                ...
                className="group border-white border p-3 rounded-full"
              >
                <BsLinkedin className="text-xl text-white/90 hover:text-primary/90 transition-all duration-300" />
              </Link>
              <Link
